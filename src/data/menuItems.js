export const menuItems = [
  ...
  },
  {
    ...
    categoryId: 'category-1',
    name: 'Double Stack',
    description: 'Two beef patties, double cheese, pickles, and special sauce.',
    price: 12.99,
    imageUrl:
  ...
  // Pizza (category-2)
  {
    ...
    name: 'Margherita',
    description: 'Fresh tomato sauce, mozzarella, and basil on a thin crust.',
    price: 11.99,
    imageUrl:
  ...
  },
  {
    ...
    name: 'Greek Salad',
    description:
      'Cucumber, tomatoes, olives, feta cheese, and olive oil dressing.',
    price: 8.99,
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Three scoops with chocolate sauce, whipped cream, and cherry.',
    price: 5.99,
