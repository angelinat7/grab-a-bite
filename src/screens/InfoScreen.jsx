    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.aboutText}>
          Welcome to Grab A Bite! We've been serving the community with fresh,
        ...
        <Text style={styles.aboutText}>
          Whether you're craving a juicy burger, authentic pizza, or a
          refreshing salad, we've got something to satisfy every appetite. We
          take pride in our fast delivery service and consistently excellent
          customer experience.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.infoRow}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoValue}>41 Fore Street</Text>
            <Text style={styles.infoValue}>Seaton, Devon, EX12 2AD</Text>
      ...
      <View style={[styles.section, styles.bottomPadding]}>
        ...
        <TouchableOpacity style={styles.infoRow}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoValue}>(01297) 123-456</Text>
        ...
        <View style={styles.infoRow}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoValue}>office@grababite.com</Text>
          </View>
        </View>
      </View>
    </ScrollView>
